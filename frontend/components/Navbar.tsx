...
export function Navbar() {
  ...
  const { data: results } = useSentimentResults();
  ...
  const totalAnalyses = results?.length || 0;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-black tracking-tighter ml-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-white/60">
                  SENTIMENT <span className="text-accent">ORACLE</span>
                </span>
              </div>
              ...
              <div className="hidden md:flex items-center gap-6 text-xs font-bold tracking-widest uppercase">
                <div className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/5">
                  ...
                  <span className="text-muted-foreground mr-1">Global Corpus:</span>
                  <span className="text-white">{totalAnalyses}</span>
                </div>
              </div>
